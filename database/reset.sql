...
-- Demo reset script — wipes and rebuilds the entire ecommerce database.
-- Run before any demo/recording to guarantee a clean starting state.
--
-- Usage:
--   mysql -u root < database/reset.sql
--
-- What it does:
--   1. Drops the ecommerce database completely
--   2. Recreates all tables (fresh schema, clean auto-increment counters)
--   3. Inserts the original admin account and all 20 products at full stock
...
-- ── Products — 20 items, all stocks reset to original values ──────────────────
